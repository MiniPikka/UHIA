...
fn efi_main(_image: Handle, mut system_table: SystemTable<Boot>) -> Status {
    ...
    stdout.clear().unwrap();
    let _ = stdout.write_str("IronAnchor v0.7.0 — UEFI Hardware Identity Agent\r\n");
    let _ = stdout.write_str("Phase 7: DXE Driver\r\n");
    ...
    let _ = stdout.write_str("\r\n=== DXE Driver Loaded Successfully ===\r\n");
    let _ = stdout.write_str("IronAnchor identity agent is now active.\r\n");
